...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-network/flexsearch.min.js');loadScript('/study-network/en.search-data.min.2b8172f7d5b71fc51c4e0b4368054f76ce4ccb74ec5c2716a7c8181f8248c7b5.js',function(){input.required=false;search();});}
