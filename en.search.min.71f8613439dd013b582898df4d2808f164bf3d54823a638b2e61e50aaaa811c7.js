...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-network/flexsearch.min.js');loadScript('/study-network/en.search-data.min.dec410f27ad1eee347eeaa076529cd62eda8a666fc082a1d9711f09f5ef0903d.js',function(){input.required=false;search();});}
