...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-network/flexsearch.min.js');loadScript('/study-network/en.search-data.min.5a6408850a18029b34a099981e6d63276e1942ba34820388d2cc3277f1eddd8d.js',function(){input.required=false;search();});}
