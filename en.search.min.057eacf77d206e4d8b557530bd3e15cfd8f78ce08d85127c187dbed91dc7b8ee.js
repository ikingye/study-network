...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-network/flexsearch.min.js');loadScript('/study-network/en.search-data.min.d45e35d6d9731c0d4e607af9d0e8ebf3601325e7d9ebfe669c86d0cdfe28b16d.js',function(){input.required=false;search();});}
