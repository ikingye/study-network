...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-network/flexsearch.min.js');loadScript('/study-network/en.search-data.min.f559cda5a31dd6c9d22d4ffc141ba1b6cc485668ba07c0ed60543fa82f1e175d.js',function(){input.required=false;search();});}
