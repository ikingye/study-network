...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-network/flexsearch.min.js');loadScript('/study-network/en.search-data.min.095819841d6eaf268ad5508fe0e30ebf24faf277a55a6d6e8c94895eaf72efb8.js',function(){input.required=false;search();});}
