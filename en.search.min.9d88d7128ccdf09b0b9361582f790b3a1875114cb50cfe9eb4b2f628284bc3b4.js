...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-network/flexsearch.min.js');loadScript('/study-network/en.search-data.min.74a89de5a60781503b10668f6923747e9c7e2b8062b9d8cac1f44d2973306121.js',function(){input.required=false;search();});}
